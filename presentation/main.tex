...
\begin{frame}[fragile]{Project Objectives}
  \begin{itemize}
    \item \textbf{Goal:} Build a robust traffic sign recognition pipeline for autonomous vehicles.
...
\begin{frame}{Dataset: GTSRB (10-class Subset)}
    ...
    \end{center}
    \begin{itemize}
        \item 14,670 images across 10 distinct traffic sign categories.
        \item \textbf{Stratified 80:20 Partition} for training and evaluation.
...
\begin{frame}{Pipeline Overview}
    \begin{columns}
        ...
        \footnotesize
        \begin{enumerate}
            \item \textbf{Data \& Preprocessing}: Stratified 80:20 split; Z-score normalization.
            ...
            \item \textbf{Dual-Track ML}: 5-Fold CV verification in High-D; 3D Manifold evaluation.
        \end{enumerate}
    \end{columns}
\end{frame}
...
\begin{frame}{Classification in 3D Space}
    \begin{columns}
        ...
        \begin{table}
            ...
            \begin{tabular}{lcc}
                \toprule
                \textbf{3D Classifier} & \textbf{R50} & IncV3 \\
                \midrule
                SGDC (Linear) & 28.94\% & 33.50\% \\
                SVM-RBF & 51.74\% & 56.99\% \\
                \textbf{Random Forest} & \textbf{82.28\%} & 79.55\% \\
                \bottomrule
            \end{tabular}
        \end{table}
    ...
    \begin{columns}
        ...
        \begin{table}
            ...
            \begin{tabularx}{\textwidth}{L C C}
                ...
                \midrule
                SGD (Lin) & 87.29\% & 88.31\% \\
                \textbf{RBF (Hyb)} & \textbf{93.46\%} & \textbf{97.24\%} \\
                \bottomrule
            \end{tabularx}
            \caption*{Accuracy (20\% Test Set)}
        \end{table}
        \footnotesize
        Results are verified with \textbf{5-Fold Cross-Validation}. RBF kernels effectively handle the density of deep manifolds, outperforming linear baselines.
